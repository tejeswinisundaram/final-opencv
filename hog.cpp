...
int main(int argc, char** argv)
{
    ...
    const char* keys =
        ...
        "{ v video     | /storage/hpc/homes//tejeswini/dataset/video/big_buck_bunny_1080p_h264.mov | use video as input }"
    ...
    {
      app.run();
      std::cout<<"AVG HOG WORK FPS : "<<app.avg_work_fps/app.count<<"\n"<<"end of program\n";
...
App::App(CommandLineParser& cmd)
{
    ...
    vdo_source="/storage/hpc/homes/tejeswini/dataset/video/BOR10_013.mpg";
   // vdo_source="/storage/hpc/homes//tejeswini/dataset/video/big_buck_bunny_480p_h264.mov";
...
void App::run()
{
    ...
    while (running)
    {
        ...
        while (running && !frame.empty())
        {
            ...
            putText(img_to_show, "", Point(5, 25), FONT_HERSHEY_SIMPLEX, 1., Scalar(255, 100, 0), 2);
            putText(img_to_show, "FPS (HOG only): " + hogWorkFps(), Point(5, 65), FONT_HERSHEY_SIMPLEX, 1., Scalar(255, 100, 0), 2);
            putText(img_to_show, "FPS (total): " + workFps(), Point(5, 105), FONT_HERSHEY_SIMPLEX, 1., Scalar(255, 100, 0), 2);
           
         //  cout<<"FPS (total): "<<work_fps<<endl;
           //cout<<"FPS(HOG only): "<<hog_work_fps<<endl;
           avg_work_fps+=hog_work_fps;
           count++;
           cout<<"HOG WORK FPS : "<<hog_work_fps<<endl; 
