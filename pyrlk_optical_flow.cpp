...
{ 
    ...
    string fname0 = "/storage/hpc/homes//tejeswini/dataset/fish1/00000021.jpg";
    string fname1 = "/storage/hpc/homes//tejeswini/dataset/fish1/00000025.jpg";


   // string vdofile = cmd.get<string>("video");
   //string vdofile = "/storage/hpc/homes/tejeswini/dataset/video/BOR10_013.mpg";
//   string vdofile = "/storage/hpc/homes//tejeswini/dataset/video/big_buck_bunny_480p_h264.mov";
  string vdofile="/storage/hpc/homes//tejeswini/dataset/video/UGS05_011.mpg";  
 //  string vdofile="storage/hpc/homes//tejeswini/dataset/video/big_buck_bunny_1080p_h264.mov";

 string outfile = cmd.get<string>("output");
//    std::string outfile = "storage/hpc/homes/tejeswini/opencvfork/opencv/pylrlink_output1.jpg";
