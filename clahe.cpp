...
int main(int argc, char** argv)
{
    ...
    string infile="/storage/hpc/homes//tejeswini/programs/data/p6.jpg";
    string outfile="/storage/hpc/homes//tejeswini/programs/data/out_p6.jpg";
  //string infile="/storage/hpc/homes/tejeswini/dataset/polarbear/00000207.jpg";
  //string outfile="/storage/hpc/homes/tejeswini/dataset/clahe-polar-op.jpg";  
   ...
   */
    ...
    std::cout << "AVERAGE TIME:" << avgfps/ctr << "\n";;
    return EXIT_SUCCESS;
}
